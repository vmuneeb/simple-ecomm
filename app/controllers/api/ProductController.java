...
public class ProductController extends Controller{
    ...
    public Result getProducts(String category,String sort) throws IOException {
        ...
        products.forEach(product -> {
            ...
            res.put("price_formatted",product.formattedPrice);
            res.put("discount_price",product.discountPrice);
            res.put("discount_price_formatted",product.discountPriceFormatted);
            res.put("main_image",product.mainImage);
            listNode.add(res);
        });
        //productsJson.set("records",Json.toJson(products));
